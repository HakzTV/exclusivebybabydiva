...
//             <Parallax className="parallax-img gold-bg" style={{overflow: 'auto'}}  blur={2} bgImage={gold} strength={100}>
          
//             </Parallax>
//               <Parallax className="parallax-img" bgImage={mens}
//                strength={300}
//                bgClassName="custom-bg-class"
//                 contentClassName="custom-content-class"
//                >
//               </Parallax>
//               <Parallax className="parallax-img" bgImage={womens} strength={-100}
//               bgClassName="custom-bg-class"
//               contentClassName="custom-content-class">
//               </Parallax>
//               <Parallax className="parallax-img" bgImage={mens} strength={-50}
//               bgClassName="custom-bg-class"
//                 contentClassName="custom-content-class"
...
//             <span>
//               To take art off the wall and out of static display. To adorn the body in wildly wonderful ways. To celebrate
//               creativity in a lavish and unique on-stage spectacular that will inspire us all.
//             </span>
//           </div>
//         </div>
//       </div>
